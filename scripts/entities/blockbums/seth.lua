...
local blockbumVar = Isaac.GetEntityVariantByName("Green Seth")

local slamCooldown = 45
local collDamage = 18
local smokeColor = Color(0.4,0.85,0.7,0.8,0,0,0)
