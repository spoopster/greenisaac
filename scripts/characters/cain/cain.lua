...
mod.MACHINES = {
    ...
    [1] = { -- SLOT
        ...
        DropTable = {
            ...
            [3]={Type=5, Variant=20, SubType=0, Count=2, Weight=2},
            ...
            [8]={Type=5, Variant=300, SubType=mod.CONSUMABLES.FLOWERING_JADE, Count=1, Weight=0.75},
            [9]={Type=5, Variant=10, SubType=0, Count=2, Weight=1},
            [10]={Type=5, Variant=20, SubType=0, Count=3, Weight=1},
            [11]={Type=5, Variant=30, SubType=0, Count=2, Weight=1},
            [12]={Type=5, Variant=40, SubType=0, Count=2, Weight=1},
            [13]={Type=13, Variant=0, SubType=0, Count=1, Weight=2},
        },
    },
    [2] = { -- BLOOD
        Type = "Machine",
    ...
    [3] = { -- FORTUNE
        ...
        DropTable = {
            ...
            [5]={Type=5, Variant=300, SubType=mod.CONSUMABLES.FLOWERING_JADE, Count=1, Weight=0.75},
